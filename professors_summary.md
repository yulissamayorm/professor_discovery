...
| 5 | [Elizabeth A. Edwards](#elizabeth-a-edwards) | University of Toronto (Department of Chemical Engineering and Applied Chemistry) | 2 | Protein amino-acid sequences (RdhA proteins, ~264-sequence curated set, Article 1) + tabular wastewater-composition / digestibility data (mill effluents × inhibitors → COD removal & methane yield, Article 2); both Reviews — no primary ML in either paper, but Article 2 has senior/last-authorship signal | 5.9 / 10 | Provisional — Article 1 middle-authored Review, Article 2 SENIOR-AUTHORED 2-author Review (stronger lab signal); both awaiting personal-interest scores |
...
- **Professor overall** = (5.4 + 6.3) / 2 = 11.7 / 2 = **5.85 ≈ 5.9 / 10** (provisional — both articles awaiting personal-interest scores)
