...
| 2 | [Seyed Mohamad Moosavi](#seyed-mohamad-moosavi) | University of Toronto (department to be confirmed) | 2 | MOF crystal structures + Monte Carlo adsorption properties (Materials Cloud); graph-similarity / data mining + property prediction; broader ML-for-materials field overview (JACS Perspective) | 7.0 / 10 | Provisional — Article 1 middle-authored, Article 2 FIRST-AUTHORED JACS Perspective (both EPFL-postdoc-era); awaiting personal-interest scores and confirmation against independent U of T group's corresponding-author work |
...
- **Professor overall** = (7.3 + 6.6) / 2 = 13.9 / 2 = 6.95 ≈ **7.0 / 10** (provisional — Article 1 is middle-authored EPFL-postdoc-era, Article 2 is **first-authored** EPFL-postdoc-era; awaiting personal-interest scores and confirmation against independent U of T group's corresponding-author work)
