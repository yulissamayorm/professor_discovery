...
| 3 | [Daniela Galatro](#daniela-galatro) | University of Toronto (Department of Mechanical and Industrial Engineering) | 1 (of 3 expected) | Tabular accelerated-aging measurements of Li-ion cells (capacity vs. time across T, SOC, C-rate, DOD, chemistry); semi-empirical regression (Dakin / Arrhenius / quadratic in stress factors) | 6.6 / 10 (provisional) | Provisional — only Article 1 processed (FIRST-AUTHORED, corresponding-author paper — strongest lab signal); awaiting personal-interest score and remaining two articles |
...
- **Common thread across their work (based on Article 1 only):** Statistical and data-based modelling of lithium-ion battery aging in EV-relevant operating regimes, with a strong focus on (a) cell-to-cell variation, (b) cross-chemistry generalisation (LMO/NMC, NCA, NMC, LFP), and (c) accelerated-test experimental design. Heavy reliance on parametric semi-empirical models (Dakin, Arrhenius, NHGP) rather than learned ML.
- **Dominant data modality:** Tabular accelerated-aging measurements — small (hundreds of rows), heterogeneous across chemistries, assembled from cited public datasets rather than lab-generated raw data.
- **Biggest obstacle for me to replicate their work publicly:** Data assembly — the underlying datasets (Keil 2016, Wikner 2017, Mathieu 2017 / MOBICUS) are public but live in source-paper tables, theses, and supplementary materials rather than as a single downloadable CSV. No code release for the Galatro paper itself.
- **Skills I would gain by working with them:** Battery aging / RUL / SOH prediction (a recognised industrial ML problem); accelerated-test experimental design; multi-factor regression with proper goodness-of-fit diagnostics (R², F-stat, p-values, learning-curve / sample-size analysis); cross-chemistry transfer learning; physics-informed regression (Arrhenius / Dakin baselines as inductive biases for ML models).

### Professor-level rollup

- **Article 1 overall:** 6.6 (provisional)
- **Articles 2 and 3:** Not yet processed.
- **Professor overall** = 6.6 / 1 = **6.6 / 10** (provisional — single article + awaiting personal-interest score; will be recomputed once Articles 2 and 3 are processed)

### Open items / notes

- Lab webpage / Google Scholar URL for Prof. Galatro not yet confirmed — verify before finalising.
- Personal interest score for Article 1 not yet provided by student.
- Articles 2 (`2.Modeling Degradation of Lithium-Ion Batteries Considering Cell-to-Cell Variations_TSpace.pdf`) and 3 (`3.Battery Health Diagnosis Approach_TSpace.pdf`) are pending — both available in `C:\Users\Yulissa\OneDrive\Escritorio\PDFs Professors\Galatro\`.
- Dataset assembly (Keil 2016 + Wikner 2017 + MOBICUS) is the highest-friction step for a portfolio project based on this article — confirm digitisation strategy before committing to it.
