...
| 5 | [Elizabeth A. Edwards](#elizabeth-a-edwards) | University of Toronto (Department of Chemical Engineering and Applied Chemistry) | 1 | Protein amino-acid sequences (reductive dehalogenase RdhA proteins, ~264-sequence curated set) — natural ML angle is protein-language-model embeddings + substrate-specificity classification | 5.4 / 10 | Provisional — single article, middle-authored Review/Perspective paper; awaiting personal-interest score and additional articles |
...
- **Professor overall** = 5.4 / 1 = **5.4 / 10** (provisional — single article, awaiting personal-interest score and additional articles)
